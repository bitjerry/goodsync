...
static PyMethodDef methods[] = {
        {"encrypt_master_key", (PyCFunction)encrypt_master_key, METH_VARARGS | METH_KEYWORDS, "Encrypt plaintext master passwords of any length"},
        {"encrypt_name", (PyCFunction)encrypt_name, METH_VARARGS | METH_KEYWORDS, "Generate GoodSync encrypted filename using encrypted master password"},
        {"decrypt_name", (PyCFunction)decrypt_name, METH_VARARGS | METH_KEYWORDS, "Decrypt GoodSync filename using encrypted master password"},
        {NULL, NULL, 0, NULL}
};
